...
This is a fork from Goob Station called Centre Station.

Probably just going to mess with things and whatnot.

## Documentation/Wiki

The Goob Station [docs site](https://docs.goobstation.com/) has documentation on GS14's content, engine, game design, and more.
